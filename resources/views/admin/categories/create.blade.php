...
@section('content')
    <h3 class="text-3xl font-medium text-gray-700 mb-6">Tambah Kategori</h3>
    ...
    <div class="bg-white rounded-lg shadow-md p-6 max-w-lg">
        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="nama_kategori" class="w-full px-3 py-2 border rounded-md" required>
            </div>

            <div class="mb-6">
                <label class="block text-gray-700 text-sm font-bold mb-2">Gambar Kategori</label>
                <input type="file" name="gambar" class="w-full px-3 py-2 border rounded-md" required>
            </div>
